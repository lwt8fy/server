...
public class FileCharsetConverter {
    ...
    public static void main(String[] args) throws Exception {
    	File file=new File("D:\\java\\JAVA\\apache-tomcat-6.0.35\\webapps\\ROOT\\jsp\\notices\\854.jsp");
    	String a=getFileContentFromCharset(file,"gbk");
    	saveFile2Charset(file,"UTF-8",a);
//        convert("D:\\836.jsp",
...
//                });
    ...
    public  void  saveFileAndCharset(String Url,String fromCharsetName,String toCharsetName ) throws Exception{
    	File file=new File(Url);
    	String a=getFileContentFromCharset(file,fromCharsetName);
    	saveFile2Charset(file,toCharsetName,a);
    }
    /**
     * 把指定文件或目录转换成指定的编码
     * 
