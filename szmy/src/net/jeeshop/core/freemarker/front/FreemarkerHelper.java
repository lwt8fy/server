...
//		}
	...
	public String staticNewsByID(String id) throws Exception {
		...
		if(news.getType().equals(net.jeeshop.services.common.News.news_type_help)){
			templateHtml = ServletActionContext.getServletContext().getRealPath("/")+"/jsp/helps/"+news.getId()+".jsp";
		}else if(news.getType().equals(net.jeeshop.services.common.News.news_type_notice)||news.getType().equals("price")){
