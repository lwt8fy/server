...
public class FrontContainer {
	...
	public static final String myBuyNow = "myBuyNow";//用户直接购买的订单
	public static final String myBid = "myBid";//用户畜禽出价信息
...
//	public static String show_user_option_error = "show_user_option_error";//显示用户操作错误信息，error.jsp页面会显示session中该key指定的错误信息，显示后会同时清除该错误信息。
	...
	public static final String validateMobile = "validateMobile";//session中的手机号
	public static final String validateMobileCode = "validateMobileCode";//session中的手机验证码
	...
	public static final String user_leftMenu_coupons = "coupons";//优惠券
	...
	public static final String user_leftMenu_selectList = "selectList";//我的收益
	public static final String user_leftMenu_favoriteShop="favoriteShop";//我的店铺收藏
