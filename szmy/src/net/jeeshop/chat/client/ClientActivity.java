...
import net.jeeshop.chat.ClientMap;
import net.jeeshop.chat.ServerListen;
import net.jeeshop.chat.beans.ChatEntity;
import net.jeeshop.chat.beans.SearchEntity;
import net.jeeshop.chat.beans.UserInfo;
import net.jeeshop.chat.commons.GlobalInts;
import net.jeeshop.chat.commons.GlobalMsgTypes;
import net.jeeshop.chat.commons.GlobalStrings;
import net.jeeshop.chat.database.DBTempSaveUtil;
...
public class ClientActivity {
	...
	public ClientActivity(Socket socket, ServerListen serverListen)
	{
		...
		try{
			mBuffRder = new BufferedReader(new InputStreamReader(mSocket.getInputStream(),"UTF-8" ) );
			mBuffWter = new BufferedWriter(new OutputStreamWriter(	mSocket.getOutputStream(),"UTF-8"));
	...
	public void startHandShake(String msg0) {
		...
		System.out.println("登录!-->ClientActivity类-->startHandShake方法,msg0==="+msg0);
	...
	public void onAskForUnsendMsgs() {
		System.out.println("start to send all unsends:发送全部未发送信息");
