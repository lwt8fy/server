package net.jeeshop.web.action.front.AppPigFarm;
	...
	public String insert() throws Exception {
		try{
			...
			if(u==null){
				...
				e.setStatus("1");
				e.setUserID(u.getId());
				this.appPigFarmService.insert(e);
				json=SUCCESS_MSG;
			}
			}catch (Exception e) {
				e.printStackTrace();
		...
		try{
			...
			if(u==null){
				...
				if(u.getSource()!=null&&u.getSource().equals("4")){
					...
					e.setName( js.get("y_name").toString());	
					e.setPhone( js.get("a_phone").toString());
					e.setUsername(js.get("a_name").toString());
					Object o = js.get("y_nf");
					if(StringUtils.isNotBlank(o.toString())){
					e.setAmount(Integer.valueOf(o.toString()));
					}
