...
//	private String productTotal;//商品总金额
	...
	private Map<String,List<Product>>compID;
	public Map<String, List<Product>> getCompID() {
		if(compID==null){
			compID = new HashMap<String,List<Product>>();
		}
		return compID;
	}
	...
	public void setCompID(Map<String, List<Product>> compID) {
		this.compID = compID;
	}
