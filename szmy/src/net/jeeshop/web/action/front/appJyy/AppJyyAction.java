package net.jeeshop.web.action.front.appJyy;
...
public class AppJyyAction extends BaseAction <AppJyy>  {
	private static final long serialVersionUID = 1L;
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(AppJyyAction.class);
	private AppJyyService appJyyService;
	public void setAppJyyService(AppJyyService appJyyService) {
		this.appJyyService=appJyyService;
	}
	...
	@Override
	public void insertAfter(AppJyy e) {
