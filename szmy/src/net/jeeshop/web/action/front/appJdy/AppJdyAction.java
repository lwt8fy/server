package net.jeeshop.web.action.front.appJdy;
...
public class AppJdyAction extends BaseAction <AppJdy>  {
	private static final long serialVersionUID = 1L;
	private static final org.slf4j.Logger logger = LoggerFactory.getLogger(AppJdyAction.class);
	private AppJdyService appJdyService;
	public void setAppJdyService(AppJdyService appJdyService) {
		this.appJdyService=appJdyService;
	}
	...
	@Override
	public void insertAfter(AppJdy e) {
