...
<%@ page import="net.jeeshop.core.util.WatermarkUtils" %>
<%
	//logo路径
	String logoimg=pageContext.getServletContext().getRealPath("/")+"resource/images/szmy_logo.png";
/**
 * KindEditor JSP
 * 
 */
...
String newFileImg=savePath+newImgName;
...
{     
      ...
      {     
			...
			WatermarkUtils.markImageByIcon(newFileImg,logoimg);
}   
