...
if(ips.contains(ip.trim())){
	System.out.println(ip+"++++++++++++++++++download.jsp");
	return;
}
%>
<%
...
.popup{ width:100%;height:330px; overflow:hidden; top:40px; position:absolute; display:none;z-index:1006;}
...
.phone_box_main{margin:2rem auto;}
...
<div class="popup am-u-sm-centered" id="popup">
  <div id="div1" class="popup_confirm">
    <form  action="<%=request.getContextPath() %>/user/regZmt.html" method="post">
    <div class="popup_box">
      ...
      <div class="phone_box_main">
          <div class="phone_box">
            ...
            <input onkeyup="javascript:$('#err_info').html('');"  name="e.mobile" type="text" id="mobile" value="${e.mobile }" />
          </div>
          <div class="phone_box">
            <label>验证码：</label>
            ...
            <button type="submit" class="am-btn am-btn-danger phone_btn"  onclick="return check_mobile();">注册</button>
      </div>    
    </div>
    </form>
  </div>
