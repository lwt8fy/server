...
if(ips.contains(ip.trim())){
	System.out.println(ip+"++++++++++++++++++download_dj.jsp");
	return;
}
%>
<%
...
if(area!=null){
	...
	String a2=request.getAttribute("area");
	if(a2==null||a2.length()==0){
		request.setAttribute("area","henan");
	}
}
if(o!=null){
	u=o.toString();
...
<div class="popup am-u-sm-centered" id="popup">
  <div id="div1" class="popup_confirm">
    <form  action="<%=request.getContextPath() %>/user/regZmtDj.html" method="post">
    <div class="popup_box">
